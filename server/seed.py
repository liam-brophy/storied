...
def seed_data():
    ...
    # Seed Notes
    notes = [
        Note(content="A haunting vision of the future.", book_id=books[0].id, user_id=users[0].id, page_number=10),
        Note(content="Chilling and prescient.", book_id=books[1].id, user_id=users[1].id, page_number=10),
        Note(content="Philosophical and eerie.", book_id=books[2].id, user_id=users[2].id, page_number=10)
    ]
